...
const PaymentForm = () => {
  ...
  const paymentHandler = async (e) => {
    ...
    console.log(
      "🚀 ~ file: payment-form.component.jsx:29 ~ paymentHandler ~ response:",
      response
    );
    ...
    console.log(
      "🚀 ~ file: payment-form.component.jsx:32 ~ paymentHandler ~ client_secret:",
      client_secret
    );
    ...
    if (paymentResult.error) {
      console.log(
        "🚀 ~ file: payment-form.component.jsx:56 ~ paymentHandler ~ paymentResult.error:",
        paymentResult.error
      );
